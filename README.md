...
<img src="https://skillicons.dev/icons?i=python,js,cpp,html,css,nodejs,react,git,github,linux,vscode,aws,terraform,jenkins,ansible,rust,arduino,docker,kubernetes,solidity,postgres,mysql,redis,gcp&theme=dark" />
